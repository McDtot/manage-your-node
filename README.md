...
[v0.4.1](https://github.com/McDtot/manage-your-node/releases/tag/v0.4.1) 完善总订阅的代理链与流量展示：

- 已下发的代理链可以和普通节点一起加入同一个总订阅链接
- 总订阅同时支持 Base64 与 Mihomo / Clash 格式的代理链输出
- 订阅列表显示普通节点的剩余、已用与总流量，剩余流量最低为零
- 数据库在启动时自动创建订阅与代理链关联表，升级无需手工迁移
